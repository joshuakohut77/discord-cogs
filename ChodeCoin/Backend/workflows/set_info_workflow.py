from ChodeCoin.Backend.utilities.message_reader import MessageReader, is_set_info_command, find_targeted_permission_data
...
class SetInfoWorkflow:
    ...
    def process_set_info_request(self, message, author):
        ...
        target_user, new_value = find_targeted_permission_data(formatted_message)
