...
class TestArrayHelper(unittest.TestCase):
    ...
    def test_GIVEN_translate_command_array_to_display_strings_WHEN_user_array_has_length_of_more_than_one_THEN_returns_all_command_strings(self) -> None:
        ...
        expected_command_string = " 1.) Command One \n &nbsp &nbsp ∟ Command One Description \n \n 2.) Command Two \n &nbsp &nbsp ∟ Command Two Description \n \n 3.) Command Three \n &nbsp &nbsp ∟ Command Three Description \n \n 4.) Command Four \n &nbsp &nbsp ∟ Command Four Description \n \n 5.) Command Five \n &nbsp &nbsp ∟ Command Five Description"
