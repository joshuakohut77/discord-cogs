...
class TestCoinManager(unittest.TestCase):
    ...
    def test_GIVEN_process_minus_minus_WHEN_target_user_exists_THEN_calls_change_coin_count_with_value_of_negative_one(self) -> None:
        # Arrange
        target_user = "UserThatExists"
        mock_usermanager = Mock()
        mock_usermanager.user_exists.return_value = True
        ...
        # Act
        coin_manager.process_minus_minus(target_user)

        # Assert
        mock_coinbankportal.change_coin_count.assert_called_once_with(target_user, -1)

    def test_GIVEN_process_minus_minus_WHEN_target_user_exists_THEN_does_not_create_new_user(
            self) -> None:
        # Arrange
        target_user = "UserThatExists"
        mock_usermanager = Mock()
    ...
    def test_GIVEN_process_minus_minus_WHEN_target_user_does_not_exist_THEN_calls_create_new_user(self) -> None:
        # Arrange
        target_user = "UserThatDoesntExist"
        mock_usermanager = Mock()
        mock_usermanager.user_exists.return_value = False
    ...
    def test_GIVEN_process_dank_hof_entry_WHEN_target_user_does_not_exist_THEN_calls_create_new_user(self) -> None:
        # Arrange
        target_user = "UserThatDoesntExist"
        mock_usermanager = Mock()
        mock_usermanager.user_exists.return_value = False
        ...
        # Act
        coin_manager.process_dank_hof_entry(target_user)

        # Assert
        mock_usermanager.create_new_user.assert_called_once()

    def test_GIVEN_process_dank_hof_entry_WHEN_target_user_exists_THEN_does_not_create_new_user(
            self) -> None:
        # Arrange
        target_user = "UserThatExists"
        mock_usermanager = Mock()
    ...
    def test_GIVEN_process_dank_hof_entry_WHEN_target_user_exists_THEN_calls_change_coin_count_with_value_of_ten(self) -> None:
        # Arrange
        target_user = "UserThatExists"
        mock_usermanager = Mock()
        mock_usermanager.user_exists.return_value = True
        ...
        # Assert
        mock_coinbankportal.change_coin_count.assert_called_once_with(target_user, 10)
