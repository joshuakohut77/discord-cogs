from ChodeCoinBackend.ChodeCoinBackend.enums.command_type import CommandType
...
class Guard:
    ...
    def against_self_plusplus(self, message, message_author):
        targeted_user = self.message_reader.format_targeted_user(message, CommandType.text)
