...
All InventoryMixin functionality has been moved to encounters.py for a unified navigation system.
...
class InventoryMixin(MixinMeta):
    """Deprecated - Inventory functionality moved to encounters.py"""
    pass
